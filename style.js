...
const cost4 = [/* "Pikachu", "Menki", "Mauzi", "Fukano", "Dodu", "Onix", "Seeper", "Rossana", "Pinsir", "Evoli",  "Marill", "Kramurx", "Sniebel", "Dummisel", "Hunduster", "Skorgla", "Kubuin", "Teddiursa", "Elekid", "Kaumalat", "Nincada", "Meditie", "Tanhel", "Sonnfel", "Relicanth", "Kindwurm", "Mampfaxo", "Rotomurf", "Ohrdoch", "Galapaflos", "Barschuft", "Flunschlik", "Gladiantri", "Viscora", "Clavion", "eF-eM", "Meikro", "Flauschling", "Kupfanti", "Grolldra", "Duraludon", "Geosali", "Forgita", "Knattox", "Gruff", "Flaminkno", "Agiluza" */ 
 ...
 "Ignivor", "Flampion", "Mammolida", "Flapteryx", "Milza", "Kapuno", "Gramokles", "Resladero", "Krabbox", "Coiffwaff", "Togedemaru", "Curelei", "Miniras", "AloMauzi", "AloVulpix", "Knapfel", "Knarbon", "Legios", "Humangolith", 
...
const cost8 = ["Ho-Oh", "Dialga", "Kyurem", "Giratina", "Yveltal", "Necrozma", "Coronospa", "Zamazenta", "Terapagos", "Miraidon"]
