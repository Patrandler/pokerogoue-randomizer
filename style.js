...
const cost4 = [/* "Pikachu", "Menki", "Mauzi", "Fukano", "Dodu", "Onix", "Seeper", "Palimpalim", "Rossana", "Pinsir", "Evoli",  "Marill", "Kramurx", "Sniebel", "Dummisel", "Hunduster", "Skorgla", "Kubuin", "Teddiursa", "Elekid", "Kaumalat", "Nincada", "Meditie", "Tanhel", "Sonnfel", "Relicanth", "Kindwurm", "Mampfaxo",  "Ohrdoch", "Galapaflos", "Barschuft", "Flunschlik", "Gladiantri", "Viscora", "Clavion", "eF-eM", "Meikro", "Flauschling", "Kupfanti", "Grolldra", "Duraludon", "Geosali", "Forgita", "Knattox", "Gruff", "Flaminkno", "Agiluza" */ 
...
const cost5 = [/* "Elektek", "Lapras", "Skaraborn", "Absol", "Karadonis", "Mopex" */ "Aerodactyl", "Kicklee", "Magmar", "Miltank", "Sengo", "Kryppuk", "Symvolara", "Frigometri", "Jiutesto", "Bisofank", "Floette", "Quartermak", "Typ: Null", "Meteno", "Moruda", "Tortunator", "Knirfish", "Lectragon", "Nigiragi"]
