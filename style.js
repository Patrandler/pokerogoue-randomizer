...
const cost2 = ["Taubsi", "Habitak", "Porenta", "Bluzuk", "Krabby", "Knilz", "Kecleon", "Volbeat", "Formeo", "Plusle", "Minun", "Pandir", "Wadribie", "Wonneira", "Bidiza", "Nagelotz", "Plaudagei", "Venuflibis", "Maracamba", "Rocara", "Scoppel", "Mabula", "AloSandan", "GalPorenta", "GalFlunschliko"];
/* "Pummeluff", "Rettan", "Voltoball", "Myrapla", "Sandan", "Enton", "Natu", "Ditto", "Felino", "Schneckmag", "Tannza", "Fiffyen", "Zigzachs", "Illumise", "Gehweiher", "Mobai", "Liebiskus", "Dusselgurr", "Irrbis", "Dedenne", "Fynx", "Mangunior", "AloRattfratz", "Sensect", "GalPonita", "Raffel", "Ferkuli" */ 
...
const cost5 = ["Aerodactyl", "Elektek", "Mew", "Kangama", "Sichlor", "Kicklee", "Magmar", "Tauros", "Lapras", "Relaxo", "Skaraborn", "Miltank", "Sengo", "Absol", "Kryppuk", "Rotom", "Symvolara", "Frigometri", "Fermicula", "Karadonis", "Jiutesto", "Shardrago", "Bisofank", "Floette"
  , "Quartermak", "Typ: Null", "Kommandutan", "Meteno", "Mimigma", "Sen-Long", "Moruda", "Tortunator", "Knirfish", "Leycrodon", "Lectragon", "Mopex", "Nigiragi", "Gierspenst", "PalTauros", "Heerashai"]
/*"Pescragon", */ 
