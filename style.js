...
const cost3 = [/* "Bisasam", "Schiggy",  "Nidoran W", "Nidoran M", "Vulpix", "Abra", "Machollo", "Ponita", "Flegmon", "Magnetilo", "Nebulak", "Tragosso", "Smogon", "Rihorn", "Goldini", "Feurigel", "Yanma", "Mogelbaum", "Pichu", "Voltilamm", "Griffel", "Traunfugil", "Kussilla" */ "Glumanda", "Kleinstein", "Amonitas", "Schlurp", "Chaneira", "Kabuto", "Tangela", "Digda", "Quapsel", "Tentacha", "Sleima", "Traumato", "Endivie", "Karnimani", "Togepi", "Lampi", "Remoraid", "Corasonn", "Pii", "Snubbull", "Baldorfish", "Phanpy",
 ...
 "Hippopotas", "Glibunkel",   "Laukaps", "Pygraulon", "Elezeba", "Praktibalk", "Schallquap",  "Waumboll", "Makabaja", "Sesokitz", "Tarnpignon", "Quabbel", "Wattzapf", "Kastadur", "Klikk",  */ "Geckarbor", "Flemmli", "Samurzel", "Seemops", "Quiekel", "Botogel", "Makuhita", "Frizelbliz", "Kanivanha", "Wailmer", "Tuska", "Schmerbe", "Krebscorps", "Liliep", "Fynx", "Anorith", "Isso", "Schneppke", "Chelast", "Panflam", "Plinfa", "Flunkifer", "Knospi", "Koknodon", "Schilterus", "Tropius", "Bamelin", "Driftlon", "Charmian", "Klingplim", "Bronzel", "Pantimimi", "Pionskora", "Mantirps", "Serpifeu", "Ottaro", 
  "Furnifraß", "Schnuthelm", "Psiau", "Skallyk", "Froxy", "Floink", "Flabébé", "Lichtel", "Riolu", "Yorkleff", "Felilou", "Reißlaus", "Knofensa", "Grillmak", "Sodamak", "Somniam", "Toxiped", "Golbit", "Kiesling", "Fleknoil", "Strawickl", "Lilminip", "Ganovil", "Lithomith", "Zurrokex", "Unratütox", "Zorua", "Picochilla", "Staralili", "Mollimorba", "Monozyto", "Piccolente", "Gelatini", "Emolga", "Zapplardin", "Petznief", "Lin-Fu"
  , /*  "Spoink",  "Dartiri",  "Paragoni", "Vegimak", "Scampisto", "Arktip", "Robball", "Choreogel", "Wommel", "Wuffels", "Lusardin", "Garstella", "Pampuli", "Araqua",  "Sankabuh", "Velursi", "GalZigzachs", "GalVoltobal", "Toxel", "Termopod", "Kamehaps", "Voldi", "Klonkett", "Fatalitee", "Cottini", "Bähmon", "Britzigel", "Blipp", "Hopplo", "Micrick", "Hefel", "Krawalloro", "Sproxi", , "Geronimatz" "Relluk", "PalFelino" */ "Igamaro", "Balgoras", "Koalelu", "Leufeo", "Mähikel", "Pam-Pam", "Parfi", "Iscalar", "Bithora", "Eguana", "Amarino", "Bauz", "Flamiau", "Bubungus", "Peppeck", "Imantis", "Molunk", "Frubberl", "Gufa", "AloKleinstein", "AloDigda", "AloSleima", "Chimpep", "GalMakabaja", "Memmeon", "GalFlegmon", "Servol", "Salanga", "Snomnom", "Wolly", "Urgel", "Pikuda", "Klopptopus", "Hokumil", "Morpeko", "Felori", "Krokel", "Kwaks", "Olini", "Mobtiff", "Weherba", "Pamo", "Voltrel", "Tentagra", "Chilingel", "Flattutu", "Schligda", "Adebom"
];
const cost4 = [/* "Pikachu", "Menki", "Mauzi", "Fukano", "Dodu", "Onix", "Seeper", "Rossana", "Pinsir", "Evoli",  "Marill", "Kramurx", "Sniebel", "Dummisel", "Hunduster", "Skorgla", "Kubuin", "Teddiursa", "Elekid", "Kaumalat", "Nincada", "Meditie", "Tanhel", "Sonnfel", "Relicanth", "Kindwurm", "Mampfaxo",  "Ohrdoch", "Galapaflos", "Barschuft", "Flunschlik", "Gladiantri", "Viscora", "Clavion", "eF-eM", "Meikro", "Flauschling", "Kupfanti", "Grolldra", "Duraludon", "Geosali", "Forgita", "Knattox", "Gruff", "Flaminkno", "Agiluza" */ 
 "Sterndu", "Owei", "Pipi", "Porygon", "Dratini", "Pottrott", "Rabauz", "Girafarig", "Panzaeron", "Absol", "Damhirplex", "Magby", "Larvitar", "Bummelz", "Lunastein", "Vepitis", "Roselia", "Qurtel", "Knacklion", "Barschwa", "Palimpalim", "Phione", 
