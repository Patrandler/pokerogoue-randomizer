...
const cost2 = ["Taubsi", "Habitak", "Porenta", "Bluzuk", "Krabby", "Knilz", "Kecleon", "Volbeat", "Formeo", "Plusle", "Minun", "Pandir", "Illumise", "Wadribie", "Wonneira", "Bidiza", "Nagelotz", "Plaudagei", "Venuflibis", "Maracamba", "Rocara", "Scoppel", "Mabula", "AloSandan", "GalPorenta", "GalFlunschliko"];
/* "Pummeluff", "Rettan", "Voltoball", "Myrapla", "Sandan", "Enton", "Natu", "Ditto", "Felino", "Schneckmag", "Tannza", "Fiffyen", "Zigzachs", "Gehweiher", "Mobai", "Liebiskus", "Dusselgurr", "Irrbis", "Dedenne", "Fynx", "Mangunior", "AloRattfratz", "Sensect", "GalPonita", "Raffel", "Ferkuli" */ 
