...
const cost3 = [/* "Bisasam", "Schiggy",  "Nidoran W", "Nidoran M", "Vulpix", "Abra", "Machollo", "Ponita", "Flegmon", "Magnetilo", "Nebulak", "Tragosso", "Smogon", "Rihorn", "Goldini", "Feurigel", "Yanma", "Mogelbaum", "Pichu", "Voltilamm", "Griffel", "Phanpy", "Traunfugil", "Kussilla" */ "Glumanda", "Kleinstein", "Amonitas", "Schlurp", "Chaneira", "Kabuto", "Tangela", "Digda", "Quapsel", "Tentacha", "Sleima", "Traumato", "Endivie", "Karnimani", "Togepi", "Lampi", "Remoraid", "Corasonn", "Pii", "Snubbull", "Baldorfish", 
 ...
 "Hippopotas", "Glibunkel",   "Laukaps", "Pygraulon", "Elezeba", "Praktibalk", "Floink", "Schallquap",  "Waumboll", "Makabaja", "Sesokitz", "Tarnpignon", "Quabbel", "Wattzapf", "Kastadur", "Klikk",  */ "Geckarbor", "Flemmli", "Samurzel", "Seemops", "Quiekel", "Botogel", "Makuhita", "Frizelbliz", "Kanivanha", "Wailmer", "Tuska", "Schmerbe", "Krebscorps", "Liliep", "Fynx", "Anorith", "Isso", "Schneppke", "Chelast", "Panflam", "Plinfa", "Flunkifer", "Knospi", "Koknodon", "Schilterus", "Tropius", "Bamelin", "Driftlon", "Charmian", "Bronzel", "Pantimimi", "Pionskora", "Serpifeu", "Ottaro", 
  ...
  , /*  "Spoink",  "Dartiri",  "Paragoni", "Vegimak", "Scampisto", "Arktip", "Robball", "Choreogel", "Mantirps", "Wommel", "Wuffels", "Lusardin", "Garstella", "Pampuli", "Araqua",  "Sankabuh", "Velursi", "Klingplim", "GalZigzachs", "GalVoltobal", "Toxel", "Termopod", "Kamehaps", "Voldi", "Klonkett", "Fatalitee", "Cottini", "Bähmon", "Britzigel", "Blipp", "Hopplo", "Micrick", "Hefel", "Peppeck", "Morpeko", "Krawalloro", "Sproxi", , "Geronimatz" "Voltrel", "Relluk", "PalFelino" */ "Igamaro", "Balgoras", "Koalelu", "Leufeo", "Mähikel", "Pam-Pam", "Parfi", "Iscalar", "Bithora", "Eguana", "Amarino", "Bauz", "Flamiau", "Bubungus", "Imantis", "Molunk", "Frubberl", "Gufa", "AloKleinstein", "AloDigda", "AloSleima", "Chimpep", "GalMakabaja", "Memmeon", "GalFlegmon", "Servol", "Salanga", "Snomnom", "Wolly", "Urgel", "Pikuda", "Klopptopus", "Hokumil", "Felori", "Krokel", "Kwaks", "Olini", "Mobtiff", "Weherba", "Pamo", "Tentagra", "Chilingel", "Flattutu", "Schligda", "Adebom"
];
const cost4 = [/* "Pikachu", "Menki", "Mauzi", "Fukano", "Dodu", "Onix", "Seeper", "Palimpalim", "Rossana", "Pinsir", "Evoli",  "Marill", "Kramurx", "Schlurm", "Sniebel", "Dummisel", "Hunduster", "Skorgla", "Kubuin", "Teddiursa", "Elekid", "Kaumalat", "Nincada", "Meditie", "Tanhel", "Sonnfel", "Relicanth", "Kindwurm", "Mampfaxo",  "Ohrdoch", "Galapaflos", "Barschuft", "Flunschlik", "Gladiantri", "Viscora", "Clavion", "eF-eM", "Meikro", "Flauschling", "Kupfanti", "Grolldra", "Duraludon", "Geosali", "Forgita", "Knattox", "Gruff", "Flaminkno", "Agiluza" */ 
 ...
 "Ignivor", "Flampion", "Mammolida", "Flapteryx", "Algitt", "Milza", "Kapuno", "Rotomurf", "Gramokles", "Resladero", "Krabbox", "Coiffwaff", "Togedemaru", "Curelei", "Miniras", "AloMauzi", "AloVulpix", "Knapfel", "Knarbon", "Legios", "Humangolith", 
...
const cost5 = [/* "Elektek", "Lapras", "Skaraborn", "Absol", "Karadonis", "Mopex" */ "Aerodactyl", "Kicklee", "Magmar", "Miltank", "Sengo", "Kryppuk", "Symvolara", "Frigometri", "Jiutesto", "Bisofank", "Floette", "Quartermak", "Typ: Null", "Meteno", "Moruda", "Tortunator", "Knirfish", "Lectragon"]
