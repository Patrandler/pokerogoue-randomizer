...
const cost2 = ["Taubsi", "Habitak", "Porenta", "Bluzuk", "Krabby", "Knilz", "Kecleon", "Volbeat", "Formeo", "Plusle", "Minun", "Pandir", "Wadribie", "Wonneira", "Bidiza", "Nagelotz", "Plaudagei", "Venuflibis", "Maracamba", "Scoppel", "Mabula", "AloSandan", "GalPorenta", "GalFlunschliko"];
/* "Pummeluff", "Rettan", "Voltoball", "Myrapla", "Sandan", "Enton", "Natu", "Ditto", "Felino", "Schneckmag", "Tannza", "Fiffyen", "Zigzachs", "Illumise", "Gehweiher", "Mobai", "Liebiskus", "Dusselgurr", "Irrbis", "Dedenne", "Rocara","Fynx", "Mangunior", "AloRattfratz", "Sensect", "GalPonita", "Raffel", "Ferkuli" */ 
