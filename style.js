...
const cost2 = ["Porenta", "Bluzuk", "Krabby", "Kecleon", "Volbeat", "Formeo", "Plusle", "Minun", "Wadribie", "Wonneira", "Bidiza", "Nagelotz", "Plaudagei", "Venuflibis", "Maracamba", "Scoppel", "Mabula", "AloSandan", "GalPorenta"];
/* "Pummeluff", "Taubsi", "Rettan", "Habitak", "Voltoball", "Knilz", "Myrapla", "Sandan", "Enton", "Natu", "Ditto", "Pandir", "Felino", "Schneckmag", "Tannza", "Fiffyen", "Zigzachs", "Illumise", "Gehweiher", "Mobai", "Liebiskus", "Dusselgurr", "GalFlunschliko", "Irrbis", "Dedenne", "Rocara","Fynx", "Mangunior", "AloRattfratz", "Sensect", "GalPonita", "Raffel", "Ferkuli" */ 
